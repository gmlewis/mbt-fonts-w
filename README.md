...
```bash
$ moon version --all
moon 0.1.20251117 (2a4820a 2025-11-17) ~/.moon/bin/moon
moonc v0.6.32+6f48aae3f (2025-11-17) ~/.moon/bin/moonc
moonrun 0.1.20251117 (2a4820a 2025-11-17) ~/.moon/bin/moonrun
moon-pilot 0.0.1-df92511 (2025-11-17) ~/.moon/bin/moon-pilot
```
